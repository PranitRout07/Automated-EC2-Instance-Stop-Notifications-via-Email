...
### Created a subscription for the SNS topic . Here i used email as protocol . 
...
### Created policy for SNS service and Cloudwatch logs
...
### Created a role for lambda service
...
### Attached policy to the role created
...
### Created a lambda function using python 3.8 and attached above role created to it
...
### Using boto3 liabrary written the lambda fucntion 
...
### Added a cloudwatch event trigger . It detects the when the ec2 instance in running state 
...
### Added another cloudwatch event trigger . It detects when the ec2 instance is in stopped state 
...
### See the lambda function diagram 
...
### Then moved to ec2 instance dashboard and stopped the ec2 instance 
<img width="1280" alt="Screenshot 2023-11-30 162325" src="https://github.com/PranitRout07/Automated-EC2-Instance-Stop-Notifications-via-Email/assets/102309095/9798bb48-6f4e-4c90-b08b-c6cd05d2719c">

### After stopping the ec2 instance received a email indicating that my ec2 instance is in stopped state now . 
<img width="1035" alt="Screenshot 2023-11-30 162429" src="https://github.com/PranitRout07/Automated-EC2-Instance-Stop-Notifications-via-Email/assets/102309095/66565523-b55e-4a01-8122-515a4569ac21">

### Then again started the ec2 instance and received email indicating that my ec2 instance is in running state now . 
<img width="1035" alt="Screenshot 2023-11-30 162554" src="https://github.com/PranitRout07/Automated-EC2-Instance-Stop-Notifications-via-Email/assets/102309095/a224e4a1-d756-42ce-b7ae-5be840755861">
